...
- Fork-only rebased commit count reviewed: `87`.
...
2. the current branch state after requested resets and retained fork-specific behavior
...
- Main evidence: `1873004139`, `e4160e9149`, `81a7b7ad39`, `262053a1aa`, `3d92c246c1`, `b2ad6ee770`.
...
- Added a large pack of local workflow skills that are not part of stock upstream here, including `skills/av-media`, `skills/azure-devops-boards`, `skills/bird`, `skills/browser`, `skills/browser-interactive`, `skills/candidate-screening`, `skills/coding-agent-max`, `skills/company-recordings-cli`, `skills/doc`, `skills/indeed-candidates-graphql`, `skills/local-places`, `skills/multi-coding-agent`, `skills/pdf-form-filler`, `skills/quickbooks`, `skills/spreadsheet`, and `skills/video-download`.
...
- Main evidence: `b8680dfe77`, `c5b420cb34`, `6a2f318a91`.
...
- This file reflects the current rebased branch state, including the requested rollbacks of the old delivery and finalization experiments and the removed sanitizer and Codex-SSE items.
