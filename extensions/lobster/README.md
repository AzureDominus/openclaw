...
Some Lobster pipelines may include a `openclaw.invoke` step to call back into OpenClaw tools/plugins (for example: `gws` for Google Workspace, `gh` for GitHub, `message.send`, etc.).
    ...
    "list": [
      {
        "id": "main",
        "tools": {
          "allow": ["lobster", "web_fetch", "web_search", "gws", "gh"],
          "deny": ["gateway"],
        },
      },
    ],
