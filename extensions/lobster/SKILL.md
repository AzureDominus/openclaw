...
```
gws gmail users.messages.list --params '{"userId":"me","q":"newer_than:1d"}' | email.triage
```
...
```
gws gmail users.messages.list --params '{"userId":"me","q":"newer_than:1d"}' | email.triage | approve --prompt 'Process these?'
```
