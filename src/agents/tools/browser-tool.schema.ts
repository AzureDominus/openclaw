...
const BROWSER_STORAGE_KINDS = ["local", "session"] as const;
const BROWSER_MEDIA_COLOR_SCHEMES = ["dark", "light", "no-preference", "none"] as const;
...
export const BrowserToolSchema = Type.Object({
  ...
  colorScheme: optionalStringEnum(BROWSER_MEDIA_COLOR_SCHEMES),
