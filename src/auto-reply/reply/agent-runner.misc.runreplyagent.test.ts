...
describe("runReplyAgent block streaming", () => {
  it("marks internal-only partial wrappers as non-user-facing", async () => {
    ...
    expect(call.onPartialReply).toEqual(expect.any(Function));
    expect(call.hasUserFacingPartialReply).toBe(false);
  });
