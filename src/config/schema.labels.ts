...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.models.*.retry": "Model Retry",
  "agents.defaults.models.*.retry.maxRetries": "Model Retry Attempts",
  "agents.defaults.models.*.retry.initialBackoffSeconds": "Model Retry Backoff Start (s)",
  "agents.defaults.models.*.retry.backoffFactor": "Model Retry Backoff Factor",
  "agents.defaults.models.*.retry.maxBackoffSeconds": "Model Retry Backoff Cap (s)",
  "agents.defaults.models.*.retry.reasons": "Model Retry Reasons",
  ...
  "agents.defaults.continueGuardRetries": "Continue Guard Retries",
  ...
  "hooks.gmail.account": "Gmail Hook Account (Legacy)",
  "hooks.gmail.label": "Gmail Hook Label (Legacy)",
  "hooks.gmail.topic": "Gmail Hook Pub/Sub Topic (Legacy)",
  "hooks.gmail.subscription": "Gmail Hook Subscription (Legacy)",
  "hooks.gmail.pushToken": "Gmail Hook Push Token (Legacy)",
  "hooks.gmail.hookUrl": "Gmail Hook Callback URL (Legacy)",
  "hooks.gmail.includeBody": "Gmail Hook Include Body (Legacy)",
  "hooks.gmail.maxBytes": "Gmail Hook Max Body Bytes (Legacy)",
  "hooks.gmail.renewEveryMinutes": "Gmail Hook Renew Interval (Legacy)",
  "hooks.gmail.allowUnsafeExternalContent": "Gmail Hook Allow Unsafe External Content",
  "hooks.gmail.serve": "Gmail Hook Local Server (Legacy)",
  "hooks.gmail.serve.bind": "Gmail Hook Server Bind Address (Legacy)",
  "hooks.gmail.serve.port": "Gmail Hook Server Port (Legacy)",
  "hooks.gmail.serve.path": "Gmail Hook Server Path (Legacy)",
  "hooks.gmail.tailscale": "Gmail Hook Tailscale (Legacy)",
  "hooks.gmail.tailscale.mode": "Gmail Hook Tailscale Mode (Legacy)",
  "hooks.gmail.tailscale.path": "Gmail Hook Tailscale Path (Legacy)",
  "hooks.gmail.tailscale.target": "Gmail Hook Tailscale Target (Legacy)",
  ...
  "channels.telegram.imageAutoDocument": "Telegram Auto Image->Document Thresholds",
  "channels.telegram.imageAutoDocument.maxBytes": "Telegram Auto Max Image Bytes",
  "channels.telegram.imageAutoDocument.maxDimensionSum": "Telegram Auto Max Dimension Sum",
  "channels.telegram.imageAutoDocument.maxAspectRatio": "Telegram Auto Max Aspect Ratio",
  "channels.telegram.imageAutoDocument.browserMaxSide": "Telegram Auto Browser Max Side",
  "channels.telegram.imageAutoDocument.browserMaxPixels": "Telegram Auto Browser Max Pixels",
  ...
  "channels.whatsapp.imageAutoDocument": "WhatsApp Auto Image->Document Thresholds",
  "channels.whatsapp.imageAutoDocument.maxBytes": "WhatsApp Auto Max Image Bytes",
  "channels.whatsapp.imageAutoDocument.browserMaxSide": "WhatsApp Auto Browser Max Side",
  "channels.whatsapp.imageAutoDocument.browserMaxPixels": "WhatsApp Auto Browser Max Pixels",
  ...
  "agents.list[].continueGuardRetries": "Continue Guard Retries",
